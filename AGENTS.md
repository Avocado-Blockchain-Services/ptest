...
For implementation work, do not read or dump pipeline, thread, or agent history created before
2026-09-22. This includes older `.pipeline/context.md` sections, historical
